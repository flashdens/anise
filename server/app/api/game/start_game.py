...
from server.app.models.game.game import GameState
...
def start_game(lobby_id):
    ...
    lobby_to_start.game.game_state.status = 2
    lobby_to_start.game.start_game()
    emit('game_started', {'lobby_id': lobby_to_start.id}, broadcast=True, include_self=False)
