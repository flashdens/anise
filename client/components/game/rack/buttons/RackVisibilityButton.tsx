...
const RackVisibilityButton = (props: RackVisibilityButtonProps) => {
    return (
         <button
            ...
            className={`fixed bottom-20 left-1/2 -translate-x-1/2 px-4 py-3 text-xs border rounded`}
          >
             <svg className={"h-5 w-5"} viewBox="0 0 330 330" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
